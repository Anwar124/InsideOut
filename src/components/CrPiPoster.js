...
import OpenPiDescriptionPopUp from "./ParkInnovationPopUp";
import HeaderInside from "./HeaderInside";
import parkPoster from "../images/posterParkInnovation.png";
import GoBack1 from "./BackFromPoster1";
...
function CrPiPoster() {
  return (
    <div className="image-container">
        <img
          src={parkPoster}
          alt="Park Innovation Poster"
          className="first-image"
        ></img>
      <OpenPiDescriptionPopUp />
      <GoBack1 />
      <HeaderInside />
